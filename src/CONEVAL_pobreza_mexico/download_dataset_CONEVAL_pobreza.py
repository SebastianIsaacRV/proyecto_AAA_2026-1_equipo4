...
RUTA_DATASETS_CONEVAL_POBREZA_MEXICO = RUTA_BASE.parent.parent / "data" / "raw" / "CONEVAL_pobreza_mexico"
RUTA_DICCIONARIOS_CONEVAL_POBREZA_MEXICO = RUTA_BASE.parent.parent / "references" / "diccionarios_CONEVAL_pobreza_mexico"
PATH_LOG_FILE = RUTA_BASE / "download_coneval_pobreza_mexico_log.log"

DATASET_PATHS = {
        "path_dataset":RUTA_DATASETS_CONEVAL_POBREZA_MEXICO,
        "path_dictionary":RUTA_DICCIONARIOS_CONEVAL_POBREZA_MEXICO
    }
...
def download_dataset(urls_datsets:list[dict[str,str]], session:requests.Session )-> None:
    """
    """
    ...
    for dataset_ in urls_datsets:
        ...
        rutas_archivo:str = Path(RUTA_DATASETS_CONEVAL_POBREZA_MEXICO) / filename_
...
def main():
    ...
    download_dataset(URLS_DATASETS, session)
    print("  Downloading datasets DONE... \n")
    print("  Generating dictionaries... \n")
    dictionary_creation(URLS_DATASETS, RUTA_DATASETS_CONEVAL_POBREZA_MEXICO, RUTA_DICCIONARIOS_CONEVAL_POBREZA_MEXICO, ".csv")
